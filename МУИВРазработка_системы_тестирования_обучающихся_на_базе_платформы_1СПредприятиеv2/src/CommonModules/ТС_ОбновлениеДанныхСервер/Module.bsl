...
Функция ВыполнитьОбновлениеСВерсии1400000()
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		СпрОбъект.ТС_Комментарий = ВыборкаДетальныеЗаписи.Комментарий;
		СпрОбъект.Комментарий = "";
		Попытка
			СпрОбъект.Записать();
		Исключение
			Сообщить(ОписаниеОшибки());
